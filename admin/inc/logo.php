...
function add_logo_dp_default_options( $dp_default_options ) {
  ...
  // Header logo for mobile
	...
	$dp_default_options['sp_header_logo_font_size'] = 26;
...
<div id="tab-content-logo">
	...
	<?php // Footer logo ?>
	<div class="theme_option_field cf">
		<h3 class="theme_option_headline"><?php _e( 'Footer logo settings', 'tcd-w' ); ?></h3>
    <h4 class="theme_option_headline2"><?php _e( 'Logo type', 'tcd-w' ); ?></h4>
		<ul>
			<?php foreach ( $use_logo_image_options as $option ) : ?>
			<li><label><input type="radio" value="<?php echo esc_attr( $option['value'] ); ?>" <?php checked( $options['footer_use_logo_image'], $option['value'] ); ?> name="dp_options[footer_use_logo_image]"> <?php echo esc_html_e( $option['label'], 'tcd-w' ); ?></label></li>
			<?php endforeach; ?>
		</ul>
		<div id="footer_use_logo_image_type1"<?php if ( 'type2' === $options['footer_use_logo_image'] ) { echo ' style="display: none;"'; } ?>>
    	<h4 class="theme_option_headline2"><?php _e( 'Font size for text logo', 'tcd-w' ); ?></h4>
		...
		<div id="footer_use_logo_image_type2"<?php if ( 'type1' === $options['footer_use_logo_image'] ) { echo ' style="display: none;"'; } ?>>
   		<h4 class="theme_option_headline2"><?php _e( 'Image for logo', 'tcd-w' ); ?></h4>
    	<div class="image_box cf">
...
function add_logo_theme_options_validate( $input ) {
  ...
  // Header logo
 	...
 	$input['header_logo_color'] = wp_filter_nohtml_kses( $input['header_logo_color'] );
  ...
  // Header logo for mobile
 	...
 	$input['sp_header_logo_color'] = wp_filter_nohtml_kses( $input['sp_header_logo_color'] );
 	$input['sp_header_logo_font_size'] = wp_filter_nohtml_kses( $input['sp_header_logo_font_size'] );
 	$input['sp_header_logo_image'] = wp_filter_nohtml_kses( $input['sp_header_logo_image'] );
